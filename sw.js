const CACHE='omni-ca942c0cd800';
const SHELL=["./","./index.html","./manifest.webmanifest","./pwa-omni/icon-192.png","./pwa-omni/icon-512.png","./assets/MonitoramentoPanel.js?v=ca942c0cd800","./assets/omni.css?v=ca942c0cd800","./assets/omni.js?v=ca942c0cd800"];
